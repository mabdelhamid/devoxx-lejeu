...
import {
  createQuizzAnswerSelectedAction,
  createSubmitQuizzAction,
  IQuizzDto
} from 'state/quizz';
...
const component = (props: IQuizzProps) => (
  <div>
    {!props.quizz.quizz && (
      <p className="alert">
        Pas de quizz bonus pour l'instant, réessaye plus tard.
      </p>
    )}
    {props.quizz.quizz &&
          ...
          <div className="panel-body">
                    ...
                    <input
                      ...
                      checked={
                        ...
                        (props.selectedAnswer ||
                          (props.quizz.quizzAnswered &&
                            props.quizz.selectedAnswer))
                      }
            ...
            {(props.isQuizzSubmitted || props.quizz.quizzAnswered) && (
              <div className="">
                ...
                (props.quizz.quizzAnswered && props.quizz.correctAnswer) ? (
                  <span className="answer-feedback good-answer">
                    {' '}
                    Bonne réponse :-)
                  </span>
                ) : (
                  <span className="answer-feedback bad-answer">
                    {' '}
                    Mauvaise réponse :-(
                  </span>
                )}
            ...
            {props.errors && (
              <span>
                {' '}
                An error occured: {props.errors}! Try refreshing your browser!{' '}
              </span>
            )}
          </div>
        </div>
